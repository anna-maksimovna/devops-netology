...
Отредактировала [hosts.yaml](https://github.com/anna-maksimovna/devops-netology/blob/main/12-kubernetes-04-install-part-2/mycluster/hosts.yaml) т.к. сгенерился какой-то странный, назвала ноды по другому и скомпановала так, чтобы была одна мастер-нода и 2 рабочих. 
